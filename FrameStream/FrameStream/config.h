 ...
 * 
 *                    Обеспечить выборку параметров из "config.txt" на SD-карте
 *                                                  и управление ими через html
 *                                                     
...
bool configfile = false;    // true - считан файл config.txt
...
// ****************************************************************************
// *             Сформировать умалчиваемую версию файла "config.txt"          *
// ****************************************************************************
const char config_txt[] PROGMEM = 
R"==x==(
roadline          // название для файлов камеры "Esp32-CAM на дорогу к даче"
13                // размер кадра = 13, для hd
420               // размер видео в секундах (на 7 минут)
...
MSK-3             // timezone
ssid#             // ssid wifi name (например, может быть "OPPO A9 2020")
12344321#         // ssid password
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Above lines - 1 item per line followed by 2 spaces

roadline - название камеры для файлов, mdns и т.д.
...
// ****************************************************************************
// *                     Выбрать параметры из "config.txt"                    *
// ****************************************************************************
void read_config_file() 
{
  ...
  if (config_file) 
  {
    sayln("Открывается config.txt на SD");
  } 
  else 
  {
    sayln("Ошибка открытия config.txt - принимаются значения по умолчанию");
  ...
  say("=========   Данные, считанные из config.txt и по умолчанию  =========\n");
