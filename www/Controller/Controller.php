...
<div id="dial" title="Виртуальный контроллер хозяйства" style="display:none;font-size:1rem;font-family:Courier;">
   ...
   <ul>
      <li><a href="#panel1">Передавать координаты туристических точек Петрозаводска через 1 сек</a></li>
   ...
   <div id="panel1" class="panel">
      ...
      <br>
      <button onclick="Test1()"><h2>Передавать координаты туристических точек Петрозаводска<h2></button>
   </div>
   <!-- Панель 2 -->
   <div id="panel2">
