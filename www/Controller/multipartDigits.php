...
// v2.0.1, 05.04.2025                                 Автор:      Труфанов В.Е.
// Copyright © 2025 tve                               Дата создания: 03.03.2025

define("imgDigits",   1);      // тестовые изображения = цифры
define("imgESP32CAM", 2);      // тестовые изображения = кадры от esp32-cam
define("imgMulti",    3);      // бегущая девочка - самые большие файлы
define("imgDir", imgMulti);    // текущие изображения
...
function GetNum()
{
   ...
   if (file_exists($count_file)) 
   {
      ...
      if (imgDir==imgESP32CAM) if ($counts[0] > 55) $counts[0]=40;
