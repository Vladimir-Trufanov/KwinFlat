...
class FixLoadTimer
{
   public function __construct($SiteHost,$ignoreOther=false)
   {
      ?>
      <script src="<?php echo $SiteHost;?>/TPhpTools/TFixLoadTimer/FixLoadTimer.js"> 
      </script>
 
      
      
      <script>
      var SiteHost="<?php echo $SiteHost;?>"+"/TPhpTools/TFixLoadTimer/FixLoadTimer.js";
      //console.log(SiteHost+"/TPhpTools/TFixLoadTimer/FixLoadTimer.js");
      console.log(SiteHost);
      //<script src="<?php echo $SiteHost;?>"> 
