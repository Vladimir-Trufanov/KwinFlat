...
// *                                                                          *
// * v4.4.0, 31.05.2025                            Автор:       Труфанов В.Е. *
// * Copyright © 2025 tve                          Дата создания:  10.03.2025 *
// ****************************************************************************

// _CreateStreamTables($pdo);                - Создать таблицу базы данных Stream
// _InsertImgStream($pdo,$src,$time,$frame); - Вставить текущее изображение  
// _SelImgStream($pdo,$intime,$inframe);     - Выбрать данные последнего записанного изображения из базы данных
