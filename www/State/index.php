...
// v4.5.3, 10.09.2025                                 Автор:      Труфанов В.Е.
...
// https://probatv.ru/State/?cycle=2&num=4&ctrl=203&sjson={"wpt":{"lat":52518611,"lon":13376111}} 
// ---------------------------------------------------------------------------- 
// https://probatv.ru/State/?cycle=2&num=-1&ctrl=201&sjson={"intrv":{"mode4":7007,"img":1001,"tempvl":3003,"lumin":2002,"bar":5005}}

// Реестр образцов запросов (типов) с json-сообщениями на State:
// 3 -> s_DHT11,  '{"dht11":{"humi":46,"tempC":248}}'                                        // Влажность = 46%, Температура = 24.8°C  
// 4 -> s_GPX,    '{"wpt":{"lat":52518611,"lon":13376111}}'                                  // Координаты точки: широта 52.518611, долгота 13.376111
