...
// v4.0.1, 22.12.2024                                 Автор:      Труфанов В.Е.
// Copyright © 2016 tve                               Дата создания: 14.08.2016

// Определяем текущее приложение
define ('APP','Kvizzy30');

/**
 * Страницы сайта:
 *  
 * Home - главная страница для показа состояния (и управления) контроллера ...
 * 
**/

// По переданным параметрам передается заказанная страница
$Page='Home';
...
try 
{
   ...
   echo "<head>";
   require_once APP.'/UpSiteHEAD.php';
   echo "</head>";
   // ---------------------------------------------------------------- BODY ---
